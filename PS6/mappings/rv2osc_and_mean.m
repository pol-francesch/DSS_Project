function [osc_sing_oe, mean_sing_oe, osc_oe,mean_oe,osc_roe,mean_roe] = rv2osc_and_mean(mu, rE, J2, J2_flag, deg_flag, chief, deputy)
    ...
    % Wrapping up %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    osc_sing_oe = [osc_sing_oe_chief; osc_sing_oe_deputy];
    mean_sing_oe = [mean_sing_oe_chief; mean_sing_oe_chief];

...
function plot_roe_state_w_init(roe_set, roe_init)
    ...
    plot(roe_init(2), roe_init(1),'.','MarkerSize',10)
    hold on
    xlabel('$a \delta \lambda $ (m)')
    ylabel('$a \delta a$ (m)')
    legend('Time History', 'Inital')
end
...
aop_c  = deg2rad(90);     % aop [rad]
ta_c   = deg2rad(270);    % true anomaly [rad]
...
oe_verify = rv2singular_oe(mu, r_c, v_c);

qns_oe_verify1 = singular2qns(oe_c);
% qns_oe_verify2 = singular2qns(oe_verify);
...
[~,z_c_j2] = ode45(@(t,z) dfq(t,z,rE,mu,J2),tspan,z0_chief,options);
[~,z_d_j2] = ode45(@(t,z) dfq(t,z,rE,mu,J2),tspan,z0_deputy,options);
...
% Numerical integration
[t,z_c_j2_nodrift] = ode45(@(t,z) dfq(t,z,rE,mu,J2),tspan,z0_chief,options);

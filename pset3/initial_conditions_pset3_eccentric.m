...
ecc_c = 0.1;         % eccentricity
% For highly eccentric
% ecc_c = 0.6;

% Initial chief absolute singular orbital parameters
sma_c  = rp / (1-ecc_c);   % semi-major axis [m] %sma_c = 10000e3;
...
[r_init_c,v_init_c] = singular_oe2rv(mu,oe_init_c); % chief position and velocity in inertial frame, J2-perturbed
...
dsma_1 = 0 / sma_c; % for non-energy matching: 100 / sma_c || for large separations: -10000 / sma_c
dlambda_1 = 0;
de_1 = 260 / sma_c;
di_1 = 222 / sma_c;
...
% Position and velocity
[r_init_d,v_init_d] = singular_oe2rv(mu,oe_init_d1); % deputy position and velocity in inertial frame, J2 perturbed
